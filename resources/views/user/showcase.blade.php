            ...
            <div class="mt-8 grid lg:grid-cols-3 gap-10">
                ...
                <div class="card hover:shadow-lg">
                    ...
                    <button type="button" onclick="event.preventDefault();
                        document.getElementById('delete-photo-user-{{$photo->id}}').submit()">
                        <a href="{{ route('admin.users.destroy', $photo->id) }}" class="text-indigo-600 hover:text-indigo-900">Delete</a> </button>
                    <form id="delete-photo-user-{{$photo->id}}" action="{{route('photo.destroy', $photo->id)}}" method="POST" style="display: none">
                        @csrf
                        @method('DELETE')
                    </form>
                    <div class="badge">
